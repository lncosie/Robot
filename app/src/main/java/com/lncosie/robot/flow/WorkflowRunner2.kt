...
//        Logger.log("Step start:" + current.descript(envirment.usernick))
...
//            Logger.loge("Step Timeout:" + current.descript(envirment.usernick))
//            work?.cancel(true)
...
//            return Task.Direction.Back
//        } finally {
//            Logger.log("Step End:" + current.descript(envirment.usernick))
//        }
//    }
//
//    fun Task.LimitRun(fn: Task.() -> Unit): Unit {
//        Logger.log("Run start:" + current.descript(envirment.usernick))
...
//        } catch(e: TimeoutException) {
//            Logger.loge("Run Timeout:" + current.descript(envirment.usernick))
//            work?.cancel(true)
//        } catch(e: Exception) {
//            e.printStackTrace()
...
//            work?.cancel(true)
//        } finally {
//            Logger.log("Run End:" + current.descript(envirment.usernick))
//            busy = false
//        }
//    }
//}